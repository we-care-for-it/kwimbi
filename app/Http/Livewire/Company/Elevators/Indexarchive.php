...
class Indexarchive extends Component
{
    ...
    public function mount(Request $request)
    {
       ...
       if (session()
            ->get('elevator_arhcive_search_filters'))
          {
            $this->filters = json_decode(session()->get('elevator_arhcive_search_filters'), true);
    ...
    public function resetFilters()
    {
        ...
        session()->pull('elevator_arhcive_search_filters', '');
       //  $this->gotoPage(1);
...
//   $this->elevators = [];
    Session()->put('elevator_arhcive_search_filters', json_encode($this->filters));
    $this->countFilters();
     ...
     public function getRowsQueryProperty(Request $request)
        {
          ...
          $query = Elevator::where('archive', 1)->when($this->filters['place'], function ($query)
            {
