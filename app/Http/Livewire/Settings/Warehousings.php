...
class Warehousings extends Component
{
    ...
    {
        return view('livewire.settings.warehousings',[
            'items' => $this->rows,
            ]);
    }
    ...
    {
        $query = warehouse::query()->when($this->filters['keyword'], function ($query) {
