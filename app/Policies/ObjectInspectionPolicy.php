...
class ObjectInspectionPolicy
{
    ...
    {
        return $user->can('view_any_object::inspection');
    }
    ...
    {
        return $user->can('create_object::inspection');
    }
    ...
    {
        return $user->can('delete_any_object::inspection');
    }
    ...
    {
        return $user->can('force_delete_any_object::inspection');
    }
    ...
    {
        return $user->can('restore_any_object::inspection');
    }
    ...
    {
        return $user->can('reorder_object::inspection');
    }
}
