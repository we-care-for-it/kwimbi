...
class UploadsRelationManager extends RelationManager
{
    ...
    {
        return $form->schema([Forms\Components\TextInput::make('name')
            ->required()
            ->columnSpan('full') ,
        ...
        Select::make('upload_type_id')
            ->label('Type')
            ->options(uploadType::where('visible_projects', 1)
            ->pluck('name', 'id'))
    ...
    public function table(Table $table):
        Table
        {
            ...
            Tables\Columns\TextColumn::make('type.name')
                ...
                ->icon('heroicon-m-pencil-square') , Tables\Actions\DeleteAction::make() , ])
                ->bulkActions([
