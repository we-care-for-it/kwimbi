...
class ObjectMaintenanceCompaniesResource extends Resource
{
    ...
    protected static ? string $navigationLabel = 'Onderhoudbedrijven';
    ...
    {
        return [
            'index' => Pages\ListObjectMaintenanceCompanies::route('/'),
            'create' => Pages\CreateObjectMaintenanceCompanies::route('/create'),
            'edit' => Pages\EditObjectMaintenanceCompanies::route('/{record}/edit'),
        ];
    }
}
