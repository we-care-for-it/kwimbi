...
class ToolsSettings extends Cluster
{
    ...
    protected static ?string $descriptionPermission = 'Beheer van leveranciers, Categorieën,Merken, Types, Keuringsbedrijven en methodes, ';
    
    
    
        protected static ?array $subPermissions = [
            'access.masterdata.tools' => 'Beheer van gereedschappenllll',
