                    ...
                    <div class="col-12">
                        ...
                        <div class="min-vh-100 content-center">
                            <div class="error-page text-center">
                                ...
                                <h5 class="fw-500">Helaas de pagina die je probeert te bereiken bestaat niet</h5>
                                <div class="content-center mt-30">
                                    <a href="/" class="btn btn-primary btn-default btn-squared px-30">Terug naar daschboard</a>
                                </div>
                            </div>
                        </div>
                        <!-- End: error page -->
