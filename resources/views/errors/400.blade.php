                    ...
                    <div class="col-12">
                        ...
                        <div class="min-vh-100 content-center">
                            <div class="error-page text-center">
                                ...
                                <h5 class="fw-500">Helaas, Er is een technische fout opgetreden probeer het later opnieuw</h5>
                                <div class="content-center mt-30">
                                    <a href="/auth/logoff" class="btn btn-primary btn-default btn-squared px-30">Loguit</a>
                                </div>
