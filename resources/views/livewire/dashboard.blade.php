...
<div class="row pt-3">
   <div class="col-md-6">
      ...
      <div class="card-header card-header-content-md-between bg-light">
Afgekeurde liften
<span class="badge bg-primary rounded-pill ms-1">{{count($elevator_expired_inspections)}}</span>
 
        </div>
         <div class = "card-body">
            <div style = "overflow-x: auto; height: 280px; overflow-x: hidden">
               ...
               <table class="table table-striped ">
                  <tbody>
                     ...
                     <tr style = "cursor: pointer; " onclick="window.location='company/elevator/show/{{ $elevator->id }}';">
                        ...
                        @if($elevator->management_elevator)
                          ...
                          {{ Carbon\Carbon::parse($elevator?->inspectionLatest?->executed_datetime)->format('d-m-Y') }}
                     
                     
                     </td>
                        <td><span class="badge bg-soft-danger text-danger py-2  py-2 "> Afgekeurd </span>
                        </td>
                        <td>
                           <small>
                           <span >	
