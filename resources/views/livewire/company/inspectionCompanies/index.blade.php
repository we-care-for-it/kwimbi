   ...
   <div class="page-header">
      <div class="row align-items-center">
         ...
         <img src="/assets/img/ico/users.png" class = "pageico">
            <h1 class="page-header-title">  Keuring instanties <span class="text-muted   ms-2"> ({{ $items->Total()}})</h1>
                        ...
                        <div>
                           ...
                           <x-table>
                              <x-slot name="head">
                                 ...
                                 <x-table.heading  sortable wire:click="sortBy('address')" :direction="$sortDirection">E-mailadres</x-table.heading>
