    ...
    <div class="page-header   ">
        <div class="row">
            ...
            <div class="col-sm-6   ">
                      ...
                      <a href = "location/add">
                                      <button     style = "float: right"   wire:loading.attr="disabled"  class="btn   btn-primary btn-sm  btn-120"
                             type="button">
               ...
               <h3 class="mb-2  pt-3">
                  <a class="text-dark" href="/location/{{$location->slug}}">
                     ...
                     <div>
                        ...
                        <span
                           class=" badge bg-soft-primary text-primary py-1">{{$location->building_type}}</span>
