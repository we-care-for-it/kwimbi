<div class="container-fluid">
   <div class="page-header     ">
      <div class="row align-items-center ">
         ...
         <h1 class="page-header-title pt-3">  Voertuigen  </h1>
             </div>
         <div class="col-auto">
            <form>
               <!-- Search -->
               ...
               <div class="row ">
                  ...
                  <div class="col-md-12 " wire:loading.remove>
                     ...
                     <div wire:loading.remove>
                        ...
                        <x-table >
                           <x-slot name="head">
                              <x-table.heading sortable wire:click="sortBy('name')">Kenteken</x-table.heading>
                           ...
                           <x-slot name="body">
                              ...
                              <x-table.row onclick="location='/supplier/{{$item->id}}'" wire:key="row-{{ $item->id }}">
                                 <x-table.cell >
                                 <a href = "/supplier/{{$item->id}}">   {{$item->kenteken}}</a>
                                 </x-table.cell>
                                 <x-table.cell>
                                    {{$item->voertuigsoort}}<br>
                                 </x-table.cell>
                                 <x-table.cell>
                                    {{$item->merk}}
                                 </x-table.cell>
                                 ...
                                 <x-table.cell>
                                 {{$item->type}}    {{$item->variant}}    {{$item->uitvoering}}
                                 </x-table.cell>
