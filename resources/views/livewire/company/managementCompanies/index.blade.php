   ...
   <div class="page-header">
      <div class="row align-items-center">
         ...
         <img src="/assets/img/ico/users.png" class = "pageico">
            <h1 class="page-header-title">  Beheerders <span class="text-muted   ms-2"> ({{ $items->Total()}})</h1>
