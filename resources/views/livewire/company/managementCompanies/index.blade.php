<div>
   ...
   <div class="row">
        <div class="col-sm-6">
            <h1 class=" page-header-title pt-2">Beheerders</h1> 
                     ...
                     <div wire:loading.remove>
                        ...
                        <x-table >
                           ...
                           <x-slot name="body">
                              ...
                              <x-table.row onclick="location='/settings/management-companie/{{$item->id}}'" wire:key="row-{{ $item->id }}">
                                 <x-table.cell >
                                 <a href = "/settings/management-companie/{{$item->id}}">   {{$item->name}}</a>
                                 </x-table.cell>
                                 <x-table.cell>
                                    {{$item->address}}<br>
                                 </x-table.cell>
