                           ...
                           <div class="flex justify-center items-center space-x-2">
                              <center>
                                 <div>
                                    ...
                                    <h4>Geen beheerders gevonden</h4>
                                    @if($this->cntFilters)
                                    Er zijn geen beheerders gevonden met de huidige filters
                                    @else
                                    Er zijn nog beheerders Keuringsinstanties gevonden in de database.
                                    @endif
                                 </div>
                              </center>
                           </div>
