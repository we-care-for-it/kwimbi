...
<div class="col-md-3">
               ...
               <div class="card ">
                  ...
                  <div class="card-body">
                     <div class="row">
                        ...
                        <div class="col-md-8">
                        <label>Externe opmerking</label>
                           <textarea rows = "5" class="form-control mb-3 mt-3" wire:model.defer="replyMessage"
                              style="background-color: #F7F4CF"></textarea>


                     <label>Interne opmerking</label>
                     <textarea  rows = "5" class="form-control mb-3 mt-3"  wire:model.defer="replyInternalMessage"
                              style="background-color: #FAE6FA"></textarea>
  ...
  <input wire:model = "stand_still"   type="checkbox" vlaue = "1" class="form-check-input" id="formSwitch1">
  <label class="form-check-label" for="formSwitch1">Lift in bedrijf</label>
</div>
            ...
            <div class="row">
               <div class="col-md-3" style="border-right: 1px solid #EFEFEF">
                  <center>
                     ...
                     @elseif($reply->status_id == 6)
                     <span class="badge bg-soft-primary text-primary">Onjuist gemeld
                     </span>
                     @elseif($reply->status_id == 7)
                     <span class="badge bg-soft-primary text-primary">Offerte in opdracht
                     </span>
   ...
   @if($reply->message)
      <label><b>Externe opmerking</b></label><br>
      {!! nl2br(e($reply->message)) !!}
   @endif     

 

   @if($reply->internalmessage) 
      <div class =  "p-2 mt-6 " style = " border-radius: 6px; border: 1px dotted #FAE6FA; border-left: 3px solid #9A4EAE;  border-top-left-radius: 0px; border-bottom-left-radius: 0px">
      <label style = "color: #4B0082">Interne opmerking</label><br>
      {!! nl2br(e($reply->internalmessage)) !!}
      </div>
   @endif       

   <br> <br>
<div style="position: absolute; bottom: 2px; border-b  " class = "py-3">
<br>
                     <small >
                        Geplaatst op:
