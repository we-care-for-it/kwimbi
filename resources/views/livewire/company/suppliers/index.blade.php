<div>
   <div class="page-header  my-3">
      <div class="row">
         <div class="col-sm-6">
            <h1 class="page-header-title pt-2">Locaties</h1>
         </div>
      </div>
   </div>
  ...
  <button type="button" data-bs-toggle="modal" data-bs-target="#crudModal" class="float-end btn btn-soft-success btn-120 " >
            Toevoegen
            </button>
