   ...
   <div class="page-header">
      <div class="row align-items-center">
         ...
         <img src="/assets/img/ico/users.png" class = "pageico">
            <h1 class="page-header-title">  Leveranciers <span class="text-muted   ms-2"> ({{ $items->Total()}})</h1>
            <span class=" mb-2 text-muted"> Toon pagina <b> {{ $items->currentPage()}} </b> van <b> {{ $items->lastPage()}} </b> met huidige filters <b> {{ $items->Total()}} </b> leveranciers gevonden</span>
         </div>
         <div class="col-auto">
