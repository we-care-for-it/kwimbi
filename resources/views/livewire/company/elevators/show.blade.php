<div class="page-header   ">
   <div class="row">
      ...
      <div class="col-sm-6   text-end">
         ...
         <a href="/elevator/edit/{{$object->id}}">
            <button type="button" class="btn   btn-link  btn-120">
               Wijzig
            </button>
         </a> <button type="button" data-bs-toggle="modal" data-bs-target="#add_incident_modal" "
              class=" btn btn btn-soft-secondary ">
   ...
   <blockquote class="blockquote blockquote-sm mb-1 mt-2 ">
      <p>{{$object?->remark}}</p>
   </blockquote>
   @endif
                     ...
                     <span class=" ">
                        ...
                        <center>
                           <img class="avatar-img " style="max-height: 90px"
                              src="/storage/{{$object?->location?->image}}">
...
<br>
     <div>
        ...
        <span
           class=" badge bg-soft-primary text-primary
                        py-1">{{config('globalValues.building_types')[$object?->location->building_type_id]}}</span>
                        @else
   ...
   <div class="col-md-9 col-xs-12">
      ...
      <div class="row   gy-4  pb-3  ">
         <div class="col-md-4">
            <div class="card  bg-light p-3 pt-xs-4" style="height: 86px;">
                     ...
                     <tbody>
                        ...
                        <tr onclick="location: '/objects/show/{{$elevator_item->id}}' " style="cursor:pointer">
                           ...
                           <td class="align-middle">
                              ...
                              <span style="float: right" class="badge bg-soft-info text-info py-1">Geopend</span>
                              @else
                           ...
                           <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-end"
                                                    ...
                                                    <a class="dropdown-item text-danger" href="#"
                                                        wire:click="deletemaintenanceContract({{$item->id}})"
                                                        wire:confirm.prompt="Weet je zeker dat je de dit onderhoudscontract wilt verwijderen?\n\nType AKKOORD voor bevestiging |AKKOORD">Verwijderen</a>
                                                </div>
                                            </div> </div>
                           </td>
                        ...
                        <tr>
                           ...
                           <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-end"
                                                    ...
                                                    <a class="dropdown-item" href="//maintenance/edit/{{$item->id}}"  
                                                        >Wijzig</a>
                                                    <div class="dropdown-divider"></div>
                                                    <a class="dropdown-item text-danger" href="#"
                                                        wire:click="deleteMaintenance({{$item->id}})"
                                                        wire:confirm.prompt="Weet je zeker dat je de deze deze onderhoudsbeurt wilt verwijderen?\n\nType AKKOORD voor bevestiging |AKKOORD">Verwijderen</a>
                                                </div>
                                            </div> </div>
                        </tr>
...
<div wire:ignore.self id="add_incident_modal" class="modal fade add_incident_modal" tabindex="-1" role="dialog"
            ...
            <div class="row">
               ...
               <div class="col-md-8">
                  ...
                  <div class="mb-3">
                     ...
                     <input class="form-control" rows="4" cols="50" wire:model.defer="contactperson_address">
                     @error('contactperson_address') <span class="invalid-feedback">{{ $message }}
                     </span> @enderror
                  </div>
               </div>
            </div>
...
<div wire:ignore.self id="add_attachment_modal" class="modal fade bs-example-modal-center" tabindex="-1" role="dialog"
   aria-labelledby="add_attachment_modal" aria-hidden="true">
   <div class="modal-dialog modal-dialog-centered modal-lg">
      <div class="modal-content">
         <div class="modal-header">
         ...
         <div class="modal-footer">
            ...
            <button wire:loading.attr="disabled" class="btn btn-soft-success btn-120   " wire:click="addUpload()"
               type="button">
               <div wire:loading>
