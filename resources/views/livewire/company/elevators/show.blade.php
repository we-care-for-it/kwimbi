...
<div class="page-header">
   <div class="row align-items-center">
      ...
      <div class="col-auto">
         <button type="button" data-bs-toggle="modal" data-bs-target="#add_incident_modal" style=" width: 190px; " class="btn btn-soft-primary">
         <i class="uil uil-exclamation-triangle me-2"></i> Storing aanmelden </button>
         <div wire:ignore.self id="add_incident_modal" class="modal fade add_incident_modal" tabindex="-1" role="dialog" aria-labelledby="mySmallModalLabel" aria-hidden="true">
               ...
               <div class="modal-content">
                  ...
                  <div class="modal-body">
                     ...
                     <div class=" bg-orange-100 border border-orange-400 text-orange-700 px-4 py-3 rounded relative" role="alert">
                        <span class="block sm:inline">Er is een storing aangemeld op deze lift, Controleer of er geen storing aangemaakt word die al aanwezig is </span>
                     </div>
                     <br> @endif
                     <div class="row">
                        <div class="col-md-4">
                           <div class=" bg-gray-100">
                              <div class="col-sm-12">
                                 <div class="mb-3">
                                    ...
                                    <input wire:model.defer="report_date_time" class="form-control" type="datetime-local">
                                 </div>
                              </div>
                              <div class="row">
                                 <div class="mb-3">
                        ...
                        <div class="col-md-8">
                           @if ($errors->any())
                           <div class="alert alert-danger" role="alert"> @foreach ($errors->all() as $error) - {{ $error }}
                              <br> @endforeach
                           </div>
                           @endif
                           <div class="mb-3">
                              <label class = "pb-2">Onderwerp</label>
                              <input class="form-control" wire:model.defer="subject" placeholder="Onderwerp van de storing">
                           </div>
                           <div class="mb-3">
                              <label class = "pb-2">Omschrijving</label>
                              <textarea class="form-control" rows="4" cols="50" wire:model.defer="descriptioni" placeholder="Beschrijf zo goed mogelijk de storing"></textarea> @error('descriptioni') <span class="invalid-feedback">{{ $message }}
                              </span> @enderror
                           </div>
                           <div class="mb-3">
                              <label class = "pb-2">Contactpersoon</label>
                              <input class="form-control" rows="4" cols="50" wire:model.defer="contactperson"> @error('contactperson') <span class="invalid-feedback">{{ $message }}
                              </span> @enderror
                           </div>
                           <div class="mb-3">
                              <label class = "pb-2">Telefoonnummer</label>
                              <input wire:model.defer="contactperson_phonenumber" type="text" class="form-control" id="inlineFormInputGroupUsername">
                           </div>
                           <div class="mb-3">
                              <label class = "pb-2">Adres</label>
                              <input class="form-control" rows="4" cols="50" wire:model.defer="contactperson_address"> @error('contactperson_address') <span class="invalid-feedback">{{ $message }}
                              </span> @enderror                
                           </div>
                        </div>
                     </div>
         ...
         <button type="button" wire:click="store()" style=" width: 150px; " class="btn btn-soft-success"> Opslaan </button>
      </div>
   </div>
</div>
@if($elevator->countIncident)
<div class=" bg-red-100 border border-red-400 text-red-700 px-4 py-3 rounded relative" role="alert">
   ...
   <span class="block sm:inline">Er is een storing gemeld op deze lift, Kijk bij storingen voor meer informatie </span>
</div>
<br> @endif @if($elevator->stand_still)
<div class="bg-red-100 border border-red-400 text-red-700 px-4 py-3 rounded relative" role="alert">
   <strong class="font-bold">Melding! </strong>
   <span class="block sm:inline">Lift buitengebruik vanaf: {{ Carbon\Carbon::parse($elevator->stand_still_date)->format('d-m-Y') }}
   </span>
</div>
<br> @endif
<div class="row">
   <div class="col-8">
      ...
      <div class="row pt-3 " >
                  ...
                  <ul class="list-unstyled mb-0">
                     ...
                     <li class="py-3">
                        <div class="d-flex align-items-center">
                           ...
                           <div class="flex-grow-1">
                              <p class="text-muted mb-1 font-size-13">E-mail </p>
                              <h5 class="mb-0 font-size-14"> @if($elevator->address?->management?->email) {{$elevator->address?->management?->email}} @else - @endif </h5>
                           </div>
                        </div>
                     </li>
                     <!-- end li -->
         ...
         <div class="col-md-4">
            <div class="card">
               <div class="card-header card-header-content-md-between bg-light">
                  Keuringinstantie
                  @if($elevator->inspection_plandate ) <span class="badge badge-soft-primary py-2 m-0" style="float: right"> Gepland: {{ Carbon\Carbon::parse($elevator->inspection_plandate)->format('d-m-Y') }}
                  </span> @endif
               </div>
               <div class="card-body" style="height: 150px;">
                  ...
                  <ul class="list-unstyled mb-0">
                     ...
                     <li class="py-3">
                        <div class="d-flex align-items-center">
                           ...
                           <div class="flex-grow-1">
                              <p class="text-muted mb-1 font-size-13">E-mail </p>
                              <h5 class="mb-0 font-size-14"> @if($elevator->inspectionCompany?->email) {{$elevator->inspectionCompany?->email}} @else - @endif </h5>
                           </div>
                        </div>
                     </li>
                     <!-- end li -->
      ...
      <div class = "row pt-3">
         <div class = "col-md-12">
            <div class="card">
               <div  class="card-header card-header-content-md-between bg-light">
                  Onderhoudscontracten <span  wire:click = "addMaintenanceContractAction()"   data-bs-toggle="modal" data-bs-target="#maintenanceContractCrudModal" class="btn btn-soft-secondary btn-sm">Toevoegen <i class="mdi mdi-plus ms-1"></i>
                  </span>
               </div>
               <div class="card-body">
                     ...
                     <tbody>
                        ...
                        <tr>
                           ...
                           <td class = "align-middle">
                              ...
                              <span class="badge  bg-soft-primary text-primary p-2"> Spreek / Luisterverbinding </span>
                              @endif
                           ...
                           <td class = "align-middle">
                              ...
                              <button  wire:click="downloadDocument('maintenancycontract','{{$maintenancycontract->id}}')"   type="button" class="btn btn-soft-success  btn-sm" id="connectionsDropdown3" data-bs-toggle="dropdown" aria-expanded="false">
                           ...
                           <td class = "align-middle">
                              <div style  = "float: right">
                                 <div style = "float:right">
                                    <button   wire:click="editMaintenancyContract({{$maintenancycontract->id}})"  type="button" data-bs-toggle="modal" data-bs-target="#maintenanceContractCrudModal"   class="btn btn-ghost-warning btn-icon btn-sm rounded-circle" id="connectionsDropdown3" data-bs-toggle="dropdown" aria-expanded="false">
                                    <i class="fa-solid fa-pencil"></i>  
                                    </button>
                                    <button  wire:click = "deleteMaintenanceContract({{$maintenancycontract->id}})" wire:confirm.prompt="Weet je zeker dat je dit onderhoudcontract wilt verwijderen ?\n\nType AKKOORD om te bevestigen|AKKOORD"  type="button" class="btn btn-ghost-danger btn-icon btn-sm rounded-circle" id="connectionsDropdown3" data-bs-toggle="dropdown" aria-expanded="false">
      ...
      <div class = "row pt-3">
         <div class = "col-md-12">
            <div class="card">
               <div class="card-header card-header-content-md-between bg-light">
                  Onderhoudsbeurten
                  <span  data-bs-toggle="modal" data-bs-target="#maintenanceCrudModal" class="btn btn-soft-secondary btn-sm">Toevoegen <i class="mdi mdi-plus ms-1"></i>
               ...
               <tbody>
                  ...
                  <tr>
                     ...
                     <td  class = "align-middle">
                        ...
                        <button class="btn btn-soft-primary btn-sm" wire:click="downloadDocument('maintenance','{{$maintenance->id}}')" style="float: right; ">
                     ...
                     <div style = "float:right">
                                    <button   wire:click="editMaintenancy({{$maintenance->id}})"  type="button" data-bs-toggle="modal" data-bs-target="#maintenanceCrudModal"   class="btn btn-ghost-warning btn-icon btn-sm rounded-circle" id="connectionsDropdown3" data-bs-toggle="dropdown" aria-expanded="false">
                                    <i class="fa-solid fa-pencil"></i>  
                                    </button>
                                    <button  wire:click = "deleteMaintenance({{$maintenance->id}})" wire:confirm.prompt="Weet je zeker dat je dit onderhoudcontract wilt verwijderen ?\n\nType AKKOORD om te bevestigen|AKKOORD"  type="button" class="btn btn-ghost-danger btn-icon btn-sm rounded-circle" id="connectionsDropdown3" data-bs-toggle="dropdown" aria-expanded="false">
                                    <i class="fa-solid fa-trash"></i>  
                                    </button>
                                 </div>
         ...
         <div class = "col-md-12">
            <div class="card">
               <div class="card-header card-header-content-md-between bg-light">
                  ...
                  <span  data-bs-toggle="modal" data-bs-target="#add_incident_modal" class="btn btn-soft-secondary btn-sm">Toevoegen <i class="mdi mdi-plus ms-1"></i>
                  ...
                  <table class="table table-striped">
                     ...
                     <tbody>
                        ...
                        <tr>
                           ...
                           <td  class = "align-middle">{{ Carbon\Carbon::parse($incident->report_date_time)->format('d-m-Y - H:i') }}
                           </td>
                           <td  class = "align-middle"> @if($incident->status_id==0) 
                              <span class="badge  bg-soft-primary text-primary p-2 py-2">Nieuw </span> @elseif($incident->status_id==2) 
                              <span class="badge  bg-soft-primary text-primary p-2  py-2 ">Doorgestuurd naar onderhoudsbedrijf </span> @elseif($incident->status_id==3) 
                              <span class="badge  bg-soft-primary text-primary p-2 py-2">Wacht op offerte </span> @elseif($incident->status_id==4)
                               <span class="badge  bg-soft-primary text-primary p-2 py-2">Offerte naar klant gestuurd </span> @elseif($incident->status_id==5) <span class="badge  bg-soft-primary text-primary p-2 ">Niet gereed </span> @elseif($incident->status_id==99) <span class="badge  bg-soft-success text-success p-2  ">Gereed </span> @endif @if($incident->stand_still) <span style="margin-top: 5px; " class=" badge rounded-pill badge-outline-danger  p-2 pl-2">
                           ...
                           <td  class = "align-middle">
                              ...
                              <div class = "pb-2 border-bottom: 1px solid #EFEFEF">
                                 <a href="#" wire:click="downloadIncidentUpload('{{$item->path}}/{{$item->filename}}')">
                           ...
                           <td  class = "align-middle">
                           <div style = "float:right">
                           <button type="button"  onclick="window.location='/company/incident/show/{{ $incident->id }}';"   class="btn btn-ghost-warning btn-icon btn-sm rounded-circle" id="connectionsDropdown3" data-bs-toggle="dropdown" aria-expanded="false">
      ...
      <div class="card">
      <div class="card-header card-header-content-md-between bg-light">
      Keuringen <span href="/lva/elevators" wire:click = "addInspection()"   data-bs-toggle="modal" data-bs-target="#inpectionCrudModal" class="btn btn-soft-secondary btn-sm">Toevoegen <i class="mdi mdi-plus ms-1"></i>
      </div>
      <div class="card-body">
      ...
      <td  class = "align-middle">{{ Carbon\Carbon::parse($inspection->executed_datetime)->format('d-m-Y') }}
      </td>
      <td  class = "align-middle">{{ Carbon\Carbon::parse($inspection->end_date)->format('d-m-Y') }}
      </td>
      <td  class = "align-middle"> @if($inspection->remark) {{$inspection->remark}} @else <small>Geen </small> @endif </td>
      <td scope="row">
      @if($inspection->document)
      <button class="btn btn-soft-primary " wire:click="downloadDocument('inspection','{{$inspection->id}}')" style="float: right; ">
      <i class="fa-solid fa-paperclip"></i> Rapportage </button>
      @endif
      @if($inspection->certification)
      <button class="btn btn-soft-primary " wire:click="downloadDocument('certification','{{$inspection->id}}')" style="float: right; margin-right: 10px;  ">
      <i class="fa-solid fa-paperclip"></i> Certificaat </button> @endif
      </td>
      <td  class = "align-middle">
      <div style = "float:right">
      <button type="button"  wire:click="editInspection({{$inspection->id}})"  data-bs-toggle="modal" data-bs-target="#inpectionCrudModal"  class="btn btn-ghost-warning btn-icon btn-sm rounded-circle" id="connectionsDropdown3" data-bs-toggle="dropdown" aria-expanded="false">
      <i class="fa-solid fa-pencil"></i>  
      </button>
      <button   wire:click="deleteInspection({{$inspection->id}})"   wire:confirm.prompt="Weet je zeker dat je deze onderhoudsbeurt wilt verwijderen ?\n\nType AKKOORD om te bevestigen|AKKOORD"  type="button" class="btn btn-ghost-danger btn-icon btn-sm rounded-circle" id="connectionsDropdown3" data-bs-toggle="dropdown" aria-expanded="false">
      <i class="fa-solid fa-trash"></i>  
      </button> 
      </div>
      </td>
      ...
      <!-- keuringen MODAL  -->
      <div class="modal fade"  wire:ignore.self  id="inpectionCrudModal" tabindex="-1" aria-labelledby="inpectionCrudModal" aria-hidden="true">
      ...
      @else
      Keuring toevoegen
      @endif<button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
      </div>
      <div class="modal-body">
      <div class="row">
      <div class="col-md-2">
      ...
      <br>      
      @if($inspection_id)
      <button wire:confirm = "Weet je zeker dat je deze bijlage wilt verwijderen ?"    wire:click="deleteInspectionDocument('document','{{$inspection?->id}}')"  class="btn btn-soft-danger ">
      ...
      <br>
      @if($inspection_id)
         <button wire:confirm = "Weet je zeker dat je deze bijlage wilt verwijderen ?"    wire:click="deleteInspectionDocument('certification','{{$inspection->id}}')"  class="btn btn-soft-danger ">
         <i class="fa-solid fa-trash"></i> Verwijder
         </button>
      @else
      <b>Bestand toegevoegd</b>
      ...
      <div class="card">
      <div class="card-header card-header-content-md-between bg-light">
      Bijlages ( {{count($this->elevator->uploads->where('type_id','!=',5))}} )
      <span data-bs-toggle="modal" data-bs-target="#add_attachment_modal" wire:click="show_upload()" class="btn btn-soft-secondary btn-sm">Toevoegen <i class="mdi mdi-plus ms-1"></i>
      </span>
      </div>
      <div class="card-body">
      @if(count($elevator->uploads->where('type_id','!=',5)))
      <table class="table table-striped">
      @foreach ($elevator->uploads->where('type_id','!=',5)->groupby('type_id') as $key => $upload)
      <body>
      @forelse ($upload as $item)
      <tr>
      <td style="width: 20px;">
      <button wire:confirm = "Weet je zeker dat je deze bijlage wilt verwijderen ?" wire:click.prevent='deleteUpload({{ $item->id }})' class="btn btn-soft-danger ">
      <i class="fa-solid fa-trash"></i>
      </button>
      </td>
      <td>
      <span class = "text-primary" style = "cursor: pointer" wire:click="downloadUpload('{{$item->path . "/" . $item->filename}}')">
      {{$item->filename}} </span><br>
      <small>Toegevoegd op:  {{ \Carbon\Carbon::parse($item->created_at)->format('d-m-Y')}}</small>
      </td>
      <td>
      ...
      @else
      Geen bijlages toegevoegd @endif
      </div>
      </div>
      </div>
      </div>
         ...
         <div class = "col-md-12">
            <div class="card">
               <div class="card-header card-header-content-md-between bg-light">
                  ...
                  <span   wire:click= "clearInspectionFields()"data-bs-toggle="modal" data-bs-target="#MJOBCrudModal" class="btn btn-soft-secondary btn-sm">Toevoegen <i class="mdi mdi-plus ms-1"></i>
                  </span>
               </div>
               <div class="card-body">
                  @if(count($elevator->uploads->where('type_id',5)))
                  <table class="table table-striped">
                     <body>
                        @foreach ($elevator->uploads->where('type_id',5) as $key => $item)
                        <tr>
                           <td style="width: 20px;">
                              <button wire:confirm = "Weet je zeker dat je deze meerjaren begroting wilt verwijderen ?" wire:click.prevent='deleteUpload({{ $item->id }})' class="btn btn-soft-danger ">
                              <i class="fa-solid fa-trash"></i>
                              </button>
                           </td>
                           <td >
                              <a href="#" wire:click="downloadUpload('upload','{{$item->path . "/" . $item->filename}}')">
                              {{$item->filename}} </a>                <br>         <small>Toegevoegd op:  {{ \Carbon\Carbon::parse($item->created_at)->format('d-m-Y')}}</small>
                           </td>
   ...
   <div class="col-4">
            ...
            <div>
               ...
               <div style="height: 40px;">
                  ...
                  <div wire:loading wire:target="get_from_liftinstituut">
                     <img src="\img\loading2.gif" style="margin-right: 10px; height: 20px; float: left; width: 20px;"> Gegegevens ophalen bij het <b>Liftinstituut B.V.</b>
                     <br>
                  </div>
                  <div wire:loading.remove>
                     <img data-bs-toggle="tooltip" data-placement="top" title=" Gegevens gesyncroniseerd op {{ Carbon\Carbon::parse($elevator->last_api_sync)->format('d-m-Y') }} om {{ Carbon\Carbon::parse($elevator->last_api_sync)->format('H:i') }}" wire:click="get_from_liftinstituut()" src="\assets\img\external\li-32x32.png" style="margin-right: 10px; height: 20px; float: left; width: 20px;"> Gegevens gesyncroniseerd <b>Liftinstituut B.V.</b>
                  </div>
                  ...
                  <br> @endif <span style="float: right" class="text-primary  cursor: pointer" wire:click="get_from_liftinstituut()" type="button">Opnieuw proberen </a> @endif
               </div>
               @endif
               ...
               @if($elevator->address)
               <div style="width: 100%">
                  <iframe width="100%" height="400" frameborder="0" scrolling="no" marginheight="0" marginwidth="0" src="https://maps.google.com/maps?width=100%25&amp;height=600&amp;hl=nl&amp;q={{$elevator->address->address}},{{$elevator->address->place}},%20Netherlands+(Mijn%20bedrijfsnaam)&amp;t=&amp;z=14&amp;ie=UTF8&amp;iwloc=B&amp;output=embed"></iframe>
               </div>
               @endif
            </div>
         </div>
      ...
      <div style="float: right">
         <button wire:click.prevent='deleteConfirmation({{ $elevator->id }})' class="btn btn-soft-danger btn-small " style="float: right">Verwijder</button>
      </div>
   </div>
</div>
<div class="row">
   <div class="col-12">
      <div class="page-title-box d-flex align-items-center justify-content-between">
         ...
         <br> @if($management_elevator) <span class="badge badge-soft-primary py-2 m-0" style="float: left">LVA Liftbeheer</span> @endif
      ...
      <div>
         <div>
            <div class="view">
               <!-- Button trigger modal -->
               <!-- keuringen MODAL  -->
               <div class="modal fade"  wire:ignore.self  id="maintenanceCrudModal" tabindex="-1" aria-labelledby="maintenanceCrudModal" aria-hidden="true">
...
<div class="modal fade"  wire:ignore.self  id="MJOBCrudModal" tabindex="-1" aria-labelledby="#MJOBCrudModal" aria-hidden="true">
      ...
      <div class="modal-content">
         ...
         <div class="modal-body">
            <div class="row">
               <div class="col-md-12">
                  <label class = "mb-3"> <br>Bijlage</label>
                  <input class="   form-control " type="file" wire:model.defer="mjob_attachment">
            ...
            <div class="row">
               <div class="col-md-6">
                  ...
                  <input class="   form-control "  wire:change = "enterEndYear" type="number" wire:model="mjob_beginyear">
         ...
         <div class="modal-footer">
            ...
            <button    wire:loading.attr="disabled"  class="btn btn-soft-success    " 
         wire:click="saveMJOB()" type="button">
      <div wire:loading >
      <span class="spinner-border spinner-border-sm" role="status" aria-hidden="true"></span>
      </div>
      Opslaan
      ...
      <div class="modal-content">
         ...
         <div class = "modal-body">
            ...
            <div class="mb-3">
               ...
               <select class="form-select @if ($errors->has('upload_type'))  is-invalid @endif" wire:model.defer="upload_type">
...
<!-- keuringen Meerjaren begrtoing  -->
<div class="modal fade"  wire:ignore.self  id="maintenanceContractCrudModal" tabindex="-1" aria-labelledby="MJOBCrudModal" aria-hidden="true">
   <div class="modal-dialog modal-dialog-centered modal-lg  "  wire:ignore.self>
      ...
      <div class = "pb-3">
               ...
               <div class="col-md-6">
                  ...
                  <br>
                  <input type = "checkbox" value="1"   class = "form-checkbox" wire:model = "maintenance_contract_option1" name = "maintenance_contract_option1" > Spreek / Luisterverbinding      <br>
                  <input type = "checkbox" value="1"  wire:model = "maintenance_contract_option2" name = "maintenance_contract_option2"> Keuring<br>      
                  <input type = "checkbox" value="1" wire:model = "maintenance_contract_option3" name = "maintenance_contract_option3"> Assistentie keuring      <br>
                  <br>
               </div>
            </div>
      ...
      @else
      <br>
      <input class="  @if ($errors->has('maintenance_contract_document'))  is-invalid @endif form-control " type="file" wire:model="maintenance_contract_document">
      @endif
