   ...
   <div class="page-header">
      <div class="row align-items-center">
         ...
         <img src="/assets/img/ico/users.png" class = "pageico">
            <h1 class="page-header-title">  Onderhoudsbedrijven <span class="text-muted   ms-2 " style = "font-weight: normal"> ({{ $items->Total()}})</span></h1>
                        ...
                        <div wire:loading.remove>
                           ...
                           <x-table>
                              <x-slot name="head">
                                 ...
                                 <x-table.heading  sortable wire:click="sortBy('address')" :direction="$sortDirection">Emailadres</x-table.heading>
