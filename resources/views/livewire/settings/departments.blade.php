<div>
   ...
   <div class="row align-items-center">
         <div class="col">
            <h1 class="page-header-title">Afdelingen</h1>
         </div>
         <div class="col-auto">
   ...
   <div class="row ">
      <div class="col-xl-12">
         ...
         <div class="card-header card-header-content-md-between bg-light">
            ...
            <div class="card-body">
            <div class="col-md-12" wire:loading.class="loading-div">
         ...
         <div class="modal-content">
               ...
               <div class="row">
                  <div class="col-md-12">
                     <div>
                        ...
                        <input wire:model="name"  wire:loading.attr="disabled" class="form-control    @error('conamede') is-invalid   @enderror  ">
            ...
            <div class="modal-footer">
               ...
               <button wire:click="delete({{$edit_id}})"
                  ...
                  type="button" class="btn btn-sm btn-link btn-120 text-danger"  style = "float: right" id="connectionsDropdown3"
