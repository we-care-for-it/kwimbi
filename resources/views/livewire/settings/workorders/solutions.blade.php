   ...
   <div class="page-header">
      ...
      <div class="row align-items-center">
         ...
         <div class="col-auto">
            ...
            <button type="button" data-bs-toggle="modal" data-bs-target="#crudModal" wire:click="clear()"
            ...
            <div class="row">
               <div class="col-md-12">
                  <div>
                     ...
                     <textarea  rows = "15" wire:model="solution"
                        class="form-control    @error('solution') is-invalid   @enderror  "></textarea>
                     @error('solution') <span class="invalid-feedback">{{ $message }}</span> @enderror
                  </div>
               </div>
            </div>
         </div>
