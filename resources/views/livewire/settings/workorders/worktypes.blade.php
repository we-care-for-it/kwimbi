                           ...
                           <table class="table">
                              ...
                              <tbody>
                                 ...
                                 <tr style = "cursor: pointer"  wire:click="edit({{$item->id}})"  data-bs-toggle="modal"
                                          ...
                                          <span class="badge bg-soft-success text-success">Actief</span>

                                          @else
                                          <span class="badge bg-soft-danger text-danger ">Niet actief</span>

                                          @endif
                                          </th>  
                                    <th class = "bg-light" scope="row"> {{$item->name}} </th>  
            ...
            <div class="modal-body" wire:loading.class="loading-div">
               <div class="row">
                  <div class="col-md-12">
                     <div>
                        ...
                        <input wire:model="name"   class="form-control    @error('code') is-invalid   @enderror  ">
               ...
               <div class="row pt-2 pb-2">
                  <div class="col-md-12">
                      ...
                      <input  value = "1" wire:model.live="is_active" type="checkbox"     @if($is_active) checked @endif >
                      <label class="form-check-label" for="formSwitch2">Actief</label>
