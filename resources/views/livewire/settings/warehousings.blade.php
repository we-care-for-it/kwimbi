                           ...
                           <div class="flex justify-center items-center space-x-2">
                              <center>
                                 <div>
                                    ...
                                    <h4>Geen magazijnen gevonden</h4>
                                    @if($this->cntFilters)
                                    Er zijn geen magazijnen gevonden met de huidige filters
                                    @else
                                    Er zijn nog geen magazijnen gevonden in de database.
                                    @endif
                                 </div>
                              </center>
                           </div>
