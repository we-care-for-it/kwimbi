...
<body>
      ...
      <main id="content" role="main" class="main">
         ...
         <h1 class="  pt-0 mt-0  " style = "color: #e6e8eb!important;;font-weight:100px!important; font-size: 40px!important;">
      Basisinstellingen </h1>
          @else
...
<option value = "Alles">Objecten</option>
                  ...
                  <div class = "col-md-10">
                     ...
                     <div   class="input-group input-group-merge w-100">
                        <input  wire:model.live="filters.keyword" type="text" wire:model.live="filters.keyword" class="js-form-search form-control"
