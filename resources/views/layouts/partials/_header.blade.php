          ...
          <div class="d-block d-sm-none">
            ...
            <div class="  ">
              <div
                ...
                style="width: 50%; left0px; top: 10px; position:absolute; float: left">
                <input type="search" class="js-form-search form-control" placeholder="Zoeken" aria-label=""
              ...
              <div class="d-none d-lg-block">
                <div
                  ...
                  <input type="search" class="js-form-search form-control"
                    placeholder="Zoek naar objecten, relaties en locaties" aria-label="" data-hs-form-search-options="{
                           &quot;clearIcon&quot;: &quot;#clearSearchResultsIcon&quot;,
                           &quot;dropMenuElement&quot;: &quot;#searchDropdownMenu&quot;,
                           &quot;dropMenuOffset&quot;: 20,
                           &quot;toggleIconOnFocus&quot;: true,
            ...
            <li class="nav-item">
              ...
              <div class="dropdown ">
                <button type="button" class="btn btn-ghost-secondary btn-icon rounded-circle" id="selectThemeDropdown"
                  data-bs-toggle="dropdown" aria-expanded="false" data-bs-dropdown-animation=""><i
                    class="bi-brightness-high"></i></button>
  ...
  <div class="container-fluid">
    ...
    <nav class="js-mega-menu navbar-nav-wrap hs-menu-initialized hs-menu-horizontal">
      ...
      <a class="navbar-brand" href="./index.html" aria-label="Front">
        <img class="navbar-brand-logo  d-none d-sm-block" src="/storage/tenant/logo.png" alt="Logo"
      ...
      <!-- <div class="navbar-collapse collapse" id="navbarDoubleLineContainerNavDropdown" style="">
        <ul class="navbar-nav">
          ...
          <li class="nav-item">
            <a id="pagesMegaMenu" class="hs-mega-menu-invoker nav-link " href="/dashboard" role="button"><i
                class="  dropdown-item-icon"></i> Overzicht</a>
          ...
          <li class="nav-item">
            <a id="pagesMegaMenu" class="hs-mega-menu-invoker nav-link " href="/locations" role="button"><i
                class="  dropdown-item-icon"></i> Locaties</a>

          </li>

          <li class="nav-item">
            <a id="pagesMegaMenu" class="hs-mega-menu-invoker nav-link " href="/incidents" role="button"><i
                class="  dropdown-item-icon"></i> Storingen</a>

          </li>


          <li class="nav-item">
            <a id="pagesMegaMenu" class="hs-mega-menu-invoker nav-link " href="/masterdata" role="button"><i
                class="  dropdown-item-icon"></i> Instellingen</a>
